...
- Keep declaration and statement modifiers attached to the modified syntax with one space, e.g. `alignas(8) int`; their contents follow the ordinary delimiter and expression rules.
