...
- **lowering**: Translating selected structural layout choices into concrete token writes, line breaks, and indentation anchors; see [architecture.md](architecture.md#lowering-selected-layouts).
