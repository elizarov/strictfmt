...
static_assert(Get("first" "second"_arg=9)==9);
static_assert(Get("first"_arg "second"=10)==10);
...
template<class... Args> constexpr void CheckFold() {
static_assert(!(Never<std::remove_const_t<std::remove_reference_t<Args>>>::value || ...),
