...
void f31(){if(a)/*1234*/{b();}else/*1234*/{c();}}
void f32(){while(a)/*1234*/{b();}}
void f33(){for(;a;)/*1234*/{b();}}
void f34(){do/*1234*/{b();}/*1234*/while(a);}
void f35(){switch(a)/*1234*/{default:break;}}
void f36(){if(a){b();}/*1234*/else{c();}}
void f37(){if(a){}/*1234*/else{b();}}
void f38(){if(a){}/*1*//*234*/else{b();}}
void f39(){try{b();}/*1234*/catch(...){c();}}
void f40(){try{b();}/*1234*/finally{c();}}
void f44(){if(a){b();}else/*1234*/{if(c){d();}}}
...
template<class T>/*1234*/requires C<T>
void f41();
