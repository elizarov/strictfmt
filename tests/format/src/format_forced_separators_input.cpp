...
void AddAssign(){value
#define MARKER 1
+= second;}

void SubtractAssign(){value
#define MARKER 1
-= second;}

void MultiplyAssign(){value
#define MARKER 1
*= second;}

void DivideAssign(){value
#define MARKER 1
/= second;}

void RemainderAssign(){value
#define MARKER 1
%= second;}

void AndAssign(){value
#define MARKER 1
&= second;}
...
void XorAssign(){value
#define MARKER 1
^= second;}

void ShiftLeftAssign(){value
#define MARKER 1
<<= second;}

void ShiftRightAssign(){value
#define MARKER 1
>>= second;}

void AlternativeAndAssign(){value
#define MARKER 1
and_eq second;}

void AlternativeOrAssign(){value
#define MARKER 1
or_eq second;}

void AlternativeXorAssign(){value
#define MARKER 1
xor_eq second;}
...
void Run(){if(first && second
#define MARKER 1
&& third && fourth){Pass();Done();}}
}
...
auto value = first ? second
#define MARKER 1
: ThirdVeryLongValue ? FourthVeryLongValue : FifthVeryLongValue;
}
...
auto value = first
#define MARKER 1
+ Call(FirstLongArgument, SecondLongArgument, ThirdLongArgument);
}
...
auto value = Name
#define MARKER 1
::AnotherVeryLongName::FinalVeryLongName;
}
...
auto Run()
#define MARKER 1
-> SomeVeryLongReturnType<First, Second, Third>;
}


namespace split_before_directive {
auto value = FirstVeryLongValue + SecondVeryLongValue + ThirdVeryLongValue
#define MARKER 1
+ FourthVeryLongValue + FifthVeryLongValue;
}
...
, VeryLongFunction(FirstLongArgument, SecondLongArgument), third);}
using Type = Box<First
#define LONG_TYPE_MARKER 1
, SecondUnavoidablyLongAtomicTypeNameThatOverflows, Third>;
}
namespace comma_lambda {
void Run(){Call(first
#define LAMBDA_ITEM_MARKER 1
, []{Prepare(); return Value();}, third);}
}
