...
constexpr auto kSyntaxKindMappings = std::to_array<SyntaxKindMapping>({
    ...
    Token(SyntaxNodeKind::BangEqual, "not_eq", Bit(SyntaxNodeClass::BinaryOperator)),
    ...
    Token(SyntaxNodeKind::Ampersand, "bitand", kChainBinaryClasses),
    Token(SyntaxNodeKind::Caret, "xor", kChainBinaryClasses),
    Token(SyntaxNodeKind::Pipe, "|", kChainBinaryClasses),
    Token(SyntaxNodeKind::Pipe, "bitor", kChainBinaryClasses),
    ...
    Token(SyntaxNodeKind::AmpersandEqual, "and_eq", Bit(SyntaxNodeClass::AssignmentOperator)),
    Token(SyntaxNodeKind::PipeEqual, "or_eq", Bit(SyntaxNodeClass::AssignmentOperator)),
    Token(SyntaxNodeKind::CaretEqual, "xor_eq", Bit(SyntaxNodeClass::AssignmentOperator)),
    ...
    Token(
        SyntaxNodeKind::ArrowStar, "->*", Bit(SyntaxNodeClass::MemberOperator) | Bit(SyntaxNodeClass::BinaryOperator)
    ),
    Token(SyntaxNodeKind::DotStar, ".*", Bit(SyntaxNodeClass::MemberOperator) | Bit(SyntaxNodeClass::BinaryOperator)),
