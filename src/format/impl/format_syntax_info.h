...
// Owns the formatter's syntax vocabulary, canonical spellings, and immutable
// parser-symbol metadata. Static kind classes exclude symbol-local properties;
// symbol queries preserve those properties and wrapper roles. Node allocation,
// tree traversal, and normalization belong to the format-model modules.
