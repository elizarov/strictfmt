...
#define array_push(self, element) \
    (_array__grow((Array*)(self), 1, array_elem_size(self)), (self)->contents[(self)->size++] = (element))
...
#define array_extend(self, count, contents) \
    _array__splice((Array*)(self), array_elem_size(self), (self)->size, 0, count, contents)
...
static inline void _array__splice(
    Array* self, size_t element_size, uint32_t index, uint32_t old_count, uint32_t new_count, const void* elements) {
